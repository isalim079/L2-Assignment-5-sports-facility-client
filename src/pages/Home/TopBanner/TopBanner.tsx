      ...
      <div className="">
        <div className="relative">
          ...
          <div className="absolute inset-0 text-white flex flex-col justify-center items-center max-w-screen-xl mx-auto space-y-7">
            <h1 className="font-archivo mt-24 lg:mt-0 text-xl text-center lg:text-5xl uppercase animate__animated animate__lightSpeedInLeft">
              Book Your Sports Experience Today
            </h1>
            <p className="text-center text-sm lg:text-base lg:w-[60%] w-[95%]">
